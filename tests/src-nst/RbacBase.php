...
class RbacBase extends RbacSetup
{
    ...
    public function testAddPathHierarchy()
    {
        ...
        $this->Instance()->addPath('/' . $this->type() . '_12/' . $this->type() . '_13/' . $this->type() . '_14', $emptyDescrips);
        $this->Instance()->addPath('/' . $this->type() . '_12/' . $this->type() . '_15/' . $this->type() . '_11', $emptyDescrips);

        $this->Instance()->addPath('/' . $this->type() . '_23/' . $this->type() . '_24/' . $this->type() . '_25', $emptyDescrips);
